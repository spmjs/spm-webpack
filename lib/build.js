...
function getWebpackOpts(opts, callback) {
  ...
  var sassLoader = 'style!' + normalize(css+'!sass', opts, 'scss');
  if (opts.build.extractCSS || files.extractCSS) {
    ...
    sassLoader = ExtractTextPlugin.extract('style', normalize(css+'!sass', opts, 'scss'));
  }
  ...
  var args = {
    ...
    module: {
      loaders: [
        ...
        { test: /\.ejs$/, loader: normalize('ejs', opts, 'atpl') },
